...
<div class="post-header">
                ...
                <img src="https://media.themoviedb.org/t/p/w440_and_h660_face/${serieData.poster_path}" class="poster-img" alt="" />
                <div class="fav-js">
      ...
      <button class="delete-btn none-btn" card-id="${serieData.id}" id="remove-btn" style="display: none;"></button>
                ...
                <div class="more-data">
                <p>Género: ${serieData.genres.map(genre => genre.name).join(', ')}</p>
                <p>Uploaded by: Homero</p>
                </div>
                </div>
                </div>
                <!-- Ventana Modal Video -->
